...
class ImageToPdfConverter:
    def __init__(self, root):
        self.root = root
        self.image_paths = []  # Corrected attribute name
    ...
    def initialize_ui(self):
        ...
        converter_button = tk.Button(self.root, text="Convert To PDF", command=self.convert_images_to_pdf)
    ...
    def convert_images_to_pdf(self):
        ...
        output_pdf_path = f"{output_pdf_name}.pdf" if output_pdf_name else "output.pdf"
        ...
        for image_path in self.image_paths:
            ...
            pdf.setFillColorRGB(1, 1, 1)  # Use RGB values for white color
